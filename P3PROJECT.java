...
public class P3PROJECT 
{
    ...
    public static String name, gender, address, agestatus, status, department, cod;
    ...
    private static void AddNewPatients()
    {
        ...
        cod = input.next();
        Patients patients = new Patients(id, name, gender, address, age, agestatus, status ,department, cod);
        NewPatient(patients);
        System.out.println("\nSuccessfully Added");
        mainfunct();
    }
